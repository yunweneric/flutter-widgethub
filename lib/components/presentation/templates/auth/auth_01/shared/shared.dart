...
class Auth01TextField extends StatelessWidget {
  final TextEditingController controller;
  final ThemeData theme;
  final String label;
  final String placeholder;
  final TextInputType? textInputType;
  const Auth01TextField({
    super.key,
...
class Auth01PasswordField extends StatelessWidget {
  final TextEditingController controller;
  final bool obscureText;
  final VoidCallback onToggleObscure;
  final ThemeData theme;
  final String label;
  const Auth01PasswordField({
    super.key,
    required this.controller,
...
class Auth01Button extends StatelessWidget {
  final String title;
  const Auth01Button({super.key, required this.title});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
...
class Auth01GoogleButton extends StatelessWidget {
  const Auth01GoogleButton({super.key});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      width: double.infinity,
...
class Auth01FacebookButton extends StatelessWidget {
  const Auth01FacebookButton({super.key});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      width: double.infinity,
