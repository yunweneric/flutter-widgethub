...
class _AppleBooksFABState extends State<AppleBooksFAB>
  ...
  List<ToggleOption> options = [
    ...
    ToggleOption(
        title: "Bookmarks & Highlights", icon: Icons.thirty_fps_outlined),
  ...
  Widget title(String title) {
    return Text(
      ...
      style: const TextStyle(
          fontSize: 32, height: 2.0, fontWeight: FontWeight.bold),
    );
  }
                ...
                children: [
                  Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: AppSizing.width(context) * paddingFactor),
                        ...
                        return Stack(
                          children: [
                            ...List.generate(items.length, (i) {
                              ...
                              return Positioned(
                                bottom: AppSizing.height(context) *
                                        animation.value *
                                        0.06 *
                                        i +
                                    kBottomNavigationBarHeight * 0.5,
                                right: AppSizing.width(context) *
                                    0.08 *
                                    animation.value,
